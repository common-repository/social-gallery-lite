...
#} Hooks
	...
	$socialGalleryLite_db_version 			= "3.1";
	$socialGalleryLite_version 				= "3.1 Lite";
	
		global $socialGalleryLite_urls;
	$socialGalleryLite_urls['home'] 		= "http://www.socialgalleryplugin.com";
	$socialGalleryLite_urls['support']		= "http://epicplugins.com/";
	...
	$socialGalleryLite_urls['gopro'] 		= 'https://goo.gl/h3Y9CD';
...
function sgp010f9_html(){
   ...
   <?php 
	...
	$premiumMsg = '<div class="socGalPremium">This Feature is only available in the Full Version. <a href="'.$socialGalleryLite_urls['gopro'].'" target="_blank">Get Social Gallery Pro</a></div>';
...
function sgpc1a_html(){
	...
	?>
	<h1><?php _e("Thanks for installing Social Gallery"); ?></h1>
	<p><?php _e("Please check out the video below which guides you through the setup"); ?></p>
	<div style="position:relative;height:0;padding-bottom:56.25%"><iframe src="https://www.youtube.com/embed/vCD9ZzpgQfE?ecver=2" width="640" height="360" frameborder="0" style="position:absolute;width:100%;height:100%;left:0" allowfullscreen></iframe></div>
...
<div id="sgpBody">
    ...
    <div id="sgpHeader">
		...
		<a href="<?php echo $socialGalleryLite_urls['gopro']; ?>" title="Become a Pro">Get Full Version</a> | Version <?php echo $socialGalleryLite_version; ?>
    </div>
